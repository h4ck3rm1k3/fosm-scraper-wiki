...
class Indexer :
    ...
    def openDB(self):
        self.dbBuckets = dbm.ndbm.open('buckets.ndbm', 'c') # bucket to url
        self.dbBlocks = dbm.ndbm.open('blocks.ndbm', 'c') # block to bucket
        self.dbNodes = dbm.ndbm.open('nodes.ndbm', 'c') # node id to block 

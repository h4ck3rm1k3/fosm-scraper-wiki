...
class Indexer :
    ...
    def openDB(self):
        self.dbBuckets = dbm.gnu.open('buckets.gdbm', 'c') # bucket to url
        self.dbBlocks = dbm.gnu.open('blocks.gdbm', 'c') # block to bucket
        self.dbNodes = dbm.gnu.open('nodes.gdbm', 'c') # node id to block 
